            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                        ...
                        <span><img width='150px' height='50px' src="{{asset('images/FARMKICKS.png')}}" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        <h2 class="display-1" style="color:#fff;">Farmkicks Store</h2>
                        <p class="h2" style="color: #ddd;padding-top:20px;padding-bottom: 20px">Kalsel Authen</p>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item active" style="height: 300px">
                      <div class="container">
                        <div class="carousel-caption">
                          <h3 class="display-4" style="color:#5e493a;font-size: 50px ;">VANS</h3>
                          <p class="h4" style="color: gray; padding-top:20px;padding-bottom: 20px">(pembuat vans)</p>
                        </div>
                      </div>
                    </div>
        ...
        <div id="hidangan" style="background-image:url({{ asset('resto/images/wood_1.png')}});">
            <div class="row">
                <div class="col-md-12" style="padding: 100px 0 50px 0">
                    <h1 class="display-4" style="color:#fff;text-align: center">Sepatu</h1>
